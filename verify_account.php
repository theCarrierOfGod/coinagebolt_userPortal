...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Verify Email | Coinagebolt</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div>
                            ...
                            <a href="/" class="mb-5 d-block auth-logo">
                                <img src="/img/logo_a.png" alt="" height="40" class="logo logo-dark">
                                <img src="/img/logo_a.png" alt="" height="40" class="logo logo-light">
                            </a>
                            <div class="card">
                                ...
                                <div class="card-body p-4"> 
                                    ...
                                    <div class="p-2 mt-4">
                                        ...
                                        ?>
                                        <form action="/verify_mail">
            
                                            <div class="mb-3">
                                                <label class="form-label" for="username">Username</label>
                                                <input type="text" class="form-control" id="username" name="username" value="<?php echo $uname; ?>" required placeholder="Enter Username">
                                            </div>
                                            
                                            <div class="mb-3">
                                                <label class="form-label" for="token">Token</label>
                                                <input type="text" class="form-control" id="token" name="token" required placeholder="Enter token">
                                            </div>
                                            
                                            <div class="mt-3 text-end">
                                                <button class="btn btn-primary w-sm waves-effect waves-light" type="submit">Verify</button>
                                            </div>
                
    
                                            <div class="mt-4 text-center">
                                                <p class="mb-0">Don't need it ? <a href="/login" class="fw-medium text-primary"> Signin </a></p>
                                                <p class="mb-0">Need verification code ? <a href="/request_verification" class="fw-medium text-primary"> Request </a></p>
                                            </div>
                                        </form>
                                    </div>
